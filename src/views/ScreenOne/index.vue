<template>
  <div class="font-white">
    <div v-bind:style="{'width':'100%',height:$store.state.windowInfo.height+'px',position:'relative'}">
      <!-- 背景地图 -->
      <div id="back-map"
           style="background:transparent;width:100%;height:100%;background-color: #0a3975">
        <iframe src="/#/overviewGis"
                class="full-width-height">
        </iframe>
      </div>

      <div style="background:linear-gradient(90deg, rgba(46, 46, 112,0.9), rgba(46, 46, 112,0.2));width:30%;height:100%;position:absolute;top:0%;left:0%">
        <!-- 天气预报及时间 -->
      ...
      <div style="background:linear-gradient(270deg, rgba(46, 46, 112,0.9), rgba(46, 46, 112,0.2));width:30%;height:100%;position:absolute;top:0%;right:0%">
        <!-- 漏控情况 -->
        <div class="full-width"
...
<style lang="less">
@import '../../static/css/g-global.less';
@import '../../static/css/m-big-screen.less';
.full-width {
    width: 100%;
}
.full-height {

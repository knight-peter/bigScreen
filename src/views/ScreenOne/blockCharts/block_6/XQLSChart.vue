<template>
  <div style="height: 100%;">
    ...
    <div style="display: flex;height:85%">
      ...
      <div
        style="width: 50%;height:100%;background-color: transparent;overflow-y:auto"
      >
      ...
      api._xqls().then(response => {
        ...
        for (let i = 0; i < response.length; i++) {
          ...
          if (tmp_percentage == null) {
            ...
            tmp_series_0.data[0].value.push(
              parseInt(item.leakage_percentage.replace("%", ""))
            );
          }
        }
        ...
        tmp_response.forEach(function(item) {
          if (item.leakage_percentage == null) {
            ...
            item.leakage_percentage = parseInt(
              item.leakage_percentage.replace("%", "")
            );
          }
        });

...
export default {
  ...
  methods: {
    load_ZJC_Statistic: function() {
      ...
      tmp_chart_options.series[0].data = [101, 203, 421, 301];
    ...
    load_GDGZ_Statistic: function() {
      ...
      tmp_chart_options.series[0].data = [98, 231, 311, 401];
      tmp_chart_options.series[0].itemStyle.normal.color.colorStops[0].color =
        "#f6ca54";
      tmp_chart_options.series[0].itemStyle.normal.color.colorStops[1].color =
        "#d5840e";
    ...
    load_ZJTR_Statistic: function() {
      ...
      tmp_chart_options.series[0].data = [121, 221, 340, 402];
      tmp_chart_options.series[0].itemStyle.normal.color.colorStops[0].color =
        "#d448ab";
      tmp_chart_options.series[0].itemStyle.normal.color.colorStops[1].color =
        "#963078";
